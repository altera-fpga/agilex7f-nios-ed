...
# create the system "qsys_ag"
proc do_create_qsys_ag {} {
	# create the system
	create_system qsys_ag
	...
	# add the components
	add_component clock_in ip/qsys_ag/qsys_ag_clock_in.ip altera_clock_bridge clock_in
	...
	save_instantiation
	add_component jtag_uart ip/qsys_ag/qsys_ag_jtag_uart_0.ip altera_avalon_jtag_uart jtag_uart_0
	...
	save_instantiation
	add_component niosv ip/qsys_ag/qsys_ag_intel_niosv_g_0.ip intel_niosv_g intel_niosv_g_0
	load_component niosv
	...
	set_component_parameter_value enableDebugReset {1}
	...
	set_component_parameter_value peripheralRegionABase {1114112}
	...
	set_component_parameter_value resetSlave {onchip_mem.s1}
	set_component_parameter_value useResetReq {0}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation niosv
	remove_instantiation_interfaces_and_ports
	...
	set_instantiation_assignment_value embeddedsw.configuration.resetSlave {onchip_mem.s1}
	...
	add_instantiation_interface dbg_reset_out reset OUTPUT
	set_instantiation_interface_parameter_value dbg_reset_out associatedClock {clk}
	set_instantiation_interface_parameter_value dbg_reset_out associatedDirectReset {}
	set_instantiation_interface_parameter_value dbg_reset_out associatedResetSinks {none}
	set_instantiation_interface_parameter_value dbg_reset_out synchronousEdges {DEASSERT}
	set_instantiation_interface_assignment_value dbg_reset_out qsys.ui.connect {ndm_reset_in}
	add_instantiation_interface_port dbg_reset_out dbg_reset_out_reset reset 1 STD_LOGIC Output
	add_instantiation_interface ndm_reset_in reset INPUT
	set_instantiation_interface_parameter_value ndm_reset_in associatedClock {clk}
	set_instantiation_interface_parameter_value ndm_reset_in synchronousEdges {DEASSERT}
	add_instantiation_interface_port ndm_reset_in ndm_reset_in_reset reset 1 STD_LOGIC Input
	save_instantiation
	add_component onchip_mem ip/qsys_ag/qsys_ag_onchip_memory2_0.ip altera_avalon_onchip_memory2 onchip_memory2_0
	load_component onchip_mem
	...
	save_instantiation
	add_component reset_in ip/qsys_ag/qsys_ag_reset_in.ip altera_reset_bridge reset_in
	...
	save_instantiation
	add_component s10_user_rst_clkgate_1 ip/qsys_ag/qsys_ag_s10_user_rst_clkgate_1.ip altera_s10_user_rst_clkgate s10_user_rst_clkgate_1
	load_component s10_user_rst_clkgate_1
	set_component_parameter_value outputType {Reset Interface}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation s10_user_rst_clkgate_1
	remove_instantiation_interfaces_and_ports
	...
	save_instantiation
	add_component sysid ip/qsys_ag/qsys_ag_sysid_qsys_0.ip altera_avalon_sysid_qsys sysid_qsys_0
	...
	save_instantiation
	add_component timer_0 ip/qsys_ag/qsys_ag_timer_0.ip altera_avalon_timer timer_0
	...
	set_instantiation_assignment_value embeddedsw.dts.params.clock-frequency {0}
	set_instantiation_assignment_value embeddedsw.dts.vendor {altr}
	add_instantiation_interface clk clock INPUT
	set_instantiation_interface_parameter_value clk clockRate {0}
	set_instantiation_interface_parameter_value clk externallyDriven {false}
	...
	set_connection_parameter_value clock_in.out_clk/jtag_uart.clk clockRateSysInfo {100000000.0}
	...
	add_connection clock_in.out_clk/niosv.clk
	set_connection_parameter_value clock_in.out_clk/niosv.clk clockDomainSysInfo {1}
	set_connection_parameter_value clock_in.out_clk/niosv.clk clockRateSysInfo {100000000.0}
	set_connection_parameter_value clock_in.out_clk/niosv.clk clockResetSysInfo {}
	set_connection_parameter_value clock_in.out_clk/niosv.clk resetDomainSysInfo {1}
	add_connection clock_in.out_clk/onchip_mem.clk1
	set_connection_parameter_value clock_in.out_clk/onchip_mem.clk1 clockDomainSysInfo {1}
	set_connection_parameter_value clock_in.out_clk/onchip_mem.clk1 clockRateSysInfo {100000000.0}
	set_connection_parameter_value clock_in.out_clk/onchip_mem.clk1 clockResetSysInfo {}
	set_connection_parameter_value clock_in.out_clk/onchip_mem.clk1 resetDomainSysInfo {1}
	...
	add_connection clock_in.out_clk/sysid.clk
	set_connection_parameter_value clock_in.out_clk/sysid.clk clockDomainSysInfo {1}
	set_connection_parameter_value clock_in.out_clk/sysid.clk clockRateSysInfo {100000000.0}
	set_connection_parameter_value clock_in.out_clk/sysid.clk clockResetSysInfo {}
	set_connection_parameter_value clock_in.out_clk/sysid.clk resetDomainSysInfo {1}
	...
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave addressMapSysInfo {<address-map><slave name='onchip_mem.s1' start='0x0' end='0x100000' datawidth='32' /><slave name='niosv.dm_agent' start='0x100000' end='0x110000' datawidth='32' /><slave name='niosv.timer_sw_agent' start='0x110000' end='0x110040' datawidth='32' /><slave name='timer_0.s1' start='0x110040' end='0x110060' datawidth='16' /><slave name='sysid.control_slave' start='0x110060' end='0x110068' datawidth='32' /><slave name='jtag_uart.avalon_jtag_slave' start='0x110068' end='0x110070' datawidth='32' /></address-map>}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave addressWidthSysInfo {}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave arbitrationPriority {1}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave baseAddress {0x00110068}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave cpuInfoIdSysInfo {}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave defaultConnection {0}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave domainAlias {}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.syncResets {TRUE}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/jtag_uart.avalon_jtag_slave slaveDataWidthSysInfo {-1}
	add_connection niosv.data_manager/niosv.dm_agent
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent addressMapSysInfo {<address-map><slave name='onchip_mem.s1' start='0x0' end='0x100000' datawidth='32' /><slave name='niosv.dm_agent' start='0x100000' end='0x110000' datawidth='32' /><slave name='niosv.timer_sw_agent' start='0x110000' end='0x110040' datawidth='32' /><slave name='timer_0.s1' start='0x110040' end='0x110060' datawidth='16' /><slave name='sysid.control_slave' start='0x110060' end='0x110068' datawidth='32' /><slave name='jtag_uart.avalon_jtag_slave' start='0x110068' end='0x110070' datawidth='32' /></address-map>}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent addressWidthSysInfo {}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent arbitrationPriority {1}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent baseAddress {0x00100000}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent cpuInfoIdSysInfo {}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent defaultConnection {0}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent domainAlias {}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.syncResets {TRUE}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/niosv.dm_agent slaveDataWidthSysInfo {-1}
	add_connection niosv.data_manager/niosv.timer_sw_agent
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent addressMapSysInfo {<address-map><slave name='onchip_mem.s1' start='0x0' end='0x100000' datawidth='32' /><slave name='niosv.dm_agent' start='0x100000' end='0x110000' datawidth='32' /><slave name='niosv.timer_sw_agent' start='0x110000' end='0x110040' datawidth='32' /><slave name='timer_0.s1' start='0x110040' end='0x110060' datawidth='16' /><slave name='sysid.control_slave' start='0x110060' end='0x110068' datawidth='32' /><slave name='jtag_uart.avalon_jtag_slave' start='0x110068' end='0x110070' datawidth='32' /></address-map>}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent addressWidthSysInfo {}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent arbitrationPriority {1}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent baseAddress {0x00110000}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent cpuInfoIdSysInfo {}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent defaultConnection {0}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent domainAlias {}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.syncResets {TRUE}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/niosv.timer_sw_agent slaveDataWidthSysInfo {-1}
	add_connection niosv.data_manager/onchip_mem.s1
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 addressMapSysInfo {<address-map><slave name='onchip_mem.s1' start='0x0' end='0x100000' datawidth='32' /><slave name='niosv.dm_agent' start='0x100000' end='0x110000' datawidth='32' /><slave name='niosv.timer_sw_agent' start='0x110000' end='0x110040' datawidth='32' /><slave name='timer_0.s1' start='0x110040' end='0x110060' datawidth='16' /><slave name='sysid.control_slave' start='0x110060' end='0x110068' datawidth='32' /><slave name='jtag_uart.avalon_jtag_slave' start='0x110068' end='0x110070' datawidth='32' /></address-map>}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 addressWidthSysInfo {}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 arbitrationPriority {1}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 baseAddress {0x0000}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 defaultConnection {0}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 domainAlias {}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/onchip_mem.s1 slaveDataWidthSysInfo {-1}
	add_connection niosv.data_manager/sysid.control_slave
	set_connection_parameter_value niosv.data_manager/sysid.control_slave addressMapSysInfo {<address-map><slave name='onchip_mem.s1' start='0x0' end='0x100000' datawidth='32' /><slave name='niosv.dm_agent' start='0x100000' end='0x110000' datawidth='32' /><slave name='niosv.timer_sw_agent' start='0x110000' end='0x110040' datawidth='32' /><slave name='timer_0.s1' start='0x110040' end='0x110060' datawidth='16' /><slave name='sysid.control_slave' start='0x110060' end='0x110068' datawidth='32' /><slave name='jtag_uart.avalon_jtag_slave' start='0x110068' end='0x110070' datawidth='32' /></address-map>}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave addressWidthSysInfo {}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave arbitrationPriority {1}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave baseAddress {0x00110060}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave cpuInfoIdSysInfo {}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave defaultConnection {0}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave domainAlias {}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.syncResets {TRUE}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/sysid.control_slave slaveDataWidthSysInfo {-1}
	add_connection niosv.data_manager/timer_0.s1
	set_connection_parameter_value niosv.data_manager/timer_0.s1 addressMapSysInfo {<address-map><slave name='onchip_mem.s1' start='0x0' end='0x100000' datawidth='32' /><slave name='niosv.dm_agent' start='0x100000' end='0x110000' datawidth='32' /><slave name='niosv.timer_sw_agent' start='0x110000' end='0x110040' datawidth='32' /><slave name='timer_0.s1' start='0x110040' end='0x110060' datawidth='16' /><slave name='sysid.control_slave' start='0x110060' end='0x110068' datawidth='32' /><slave name='jtag_uart.avalon_jtag_slave' start='0x110068' end='0x110070' datawidth='32' /></address-map>}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 addressWidthSysInfo {}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 arbitrationPriority {1}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 baseAddress {0x00110040}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 defaultConnection {0}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 domainAlias {}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.data_manager/timer_0.s1 slaveDataWidthSysInfo {-1}
	add_connection niosv.dbg_reset_out/jtag_uart.reset
	set_connection_parameter_value niosv.dbg_reset_out/jtag_uart.reset clockDomainSysInfo {2}
	set_connection_parameter_value niosv.dbg_reset_out/jtag_uart.reset clockResetSysInfo {}
	set_connection_parameter_value niosv.dbg_reset_out/jtag_uart.reset resetDomainSysInfo {2}
	add_connection niosv.dbg_reset_out/niosv.ndm_reset_in
	set_connection_parameter_value niosv.dbg_reset_out/niosv.ndm_reset_in clockDomainSysInfo {2}
	set_connection_parameter_value niosv.dbg_reset_out/niosv.ndm_reset_in clockResetSysInfo {}
	set_connection_parameter_value niosv.dbg_reset_out/niosv.ndm_reset_in resetDomainSysInfo {2}
	add_connection niosv.dbg_reset_out/onchip_mem.reset1
	set_connection_parameter_value niosv.dbg_reset_out/onchip_mem.reset1 clockDomainSysInfo {2}
	set_connection_parameter_value niosv.dbg_reset_out/onchip_mem.reset1 clockResetSysInfo {}
	set_connection_parameter_value niosv.dbg_reset_out/onchip_mem.reset1 resetDomainSysInfo {2}
	add_connection niosv.dbg_reset_out/sysid.reset
	set_connection_parameter_value niosv.dbg_reset_out/sysid.reset clockDomainSysInfo {2}
	set_connection_parameter_value niosv.dbg_reset_out/sysid.reset clockResetSysInfo {}
	set_connection_parameter_value niosv.dbg_reset_out/sysid.reset resetDomainSysInfo {2}
	add_connection niosv.dbg_reset_out/timer_0.reset
	set_connection_parameter_value niosv.dbg_reset_out/timer_0.reset clockDomainSysInfo {2}
	set_connection_parameter_value niosv.dbg_reset_out/timer_0.reset clockResetSysInfo {}
	set_connection_parameter_value niosv.dbg_reset_out/timer_0.reset resetDomainSysInfo {2}
	add_connection niosv.instruction_manager/niosv.dm_agent
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent addressMapSysInfo {<address-map><slave name='onchip_mem.s1' start='0x0' end='0x100000' datawidth='32' /><slave name='niosv.dm_agent' start='0x100000' end='0x110000' datawidth='32' /></address-map>}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent addressWidthSysInfo {}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent arbitrationPriority {1}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent baseAddress {0x00100000}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent cpuInfoIdSysInfo {}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent defaultConnection {0}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent domainAlias {}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.syncResets {TRUE}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.instruction_manager/niosv.dm_agent slaveDataWidthSysInfo {-1}
	add_connection niosv.instruction_manager/onchip_mem.s1
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 addressMapSysInfo {<address-map><slave name='onchip_mem.s1' start='0x0' end='0x100000' datawidth='32' /><slave name='niosv.dm_agent' start='0x100000' end='0x110000' datawidth='32' /></address-map>}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 addressWidthSysInfo {}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 arbitrationPriority {1}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 baseAddress {0x0000}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 defaultConnection {0}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 domainAlias {}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value niosv.instruction_manager/onchip_mem.s1 slaveDataWidthSysInfo {-1}
	add_connection niosv.platform_irq_rx/jtag_uart.irq
	set_connection_parameter_value niosv.platform_irq_rx/jtag_uart.irq interruptsUsedSysInfo {-1}
	set_connection_parameter_value niosv.platform_irq_rx/jtag_uart.irq irqNumber {0}
	add_connection niosv.platform_irq_rx/timer_0.irq
	set_connection_parameter_value niosv.platform_irq_rx/timer_0.irq interruptsUsedSysInfo {-1}
	set_connection_parameter_value niosv.platform_irq_rx/timer_0.irq irqNumber {1}
	add_connection reset_in.out_reset/jtag_uart.reset
	set_connection_parameter_value reset_in.out_reset/jtag_uart.reset clockDomainSysInfo {3}
	set_connection_parameter_value reset_in.out_reset/jtag_uart.reset clockResetSysInfo {}
	set_connection_parameter_value reset_in.out_reset/jtag_uart.reset resetDomainSysInfo {3}
	add_connection reset_in.out_reset/niosv.reset
	set_connection_parameter_value reset_in.out_reset/niosv.reset clockDomainSysInfo {3}
	set_connection_parameter_value reset_in.out_reset/niosv.reset clockResetSysInfo {}
	set_connection_parameter_value reset_in.out_reset/niosv.reset resetDomainSysInfo {3}
	add_connection reset_in.out_reset/onchip_mem.reset1
	set_connection_parameter_value reset_in.out_reset/onchip_mem.reset1 clockDomainSysInfo {3}
	set_connection_parameter_value reset_in.out_reset/onchip_mem.reset1 clockResetSysInfo {}
	set_connection_parameter_value reset_in.out_reset/onchip_mem.reset1 resetDomainSysInfo {3}
	add_connection reset_in.out_reset/sysid.reset
	set_connection_parameter_value reset_in.out_reset/sysid.reset clockDomainSysInfo {3}
	set_connection_parameter_value reset_in.out_reset/sysid.reset clockResetSysInfo {}
	set_connection_parameter_value reset_in.out_reset/sysid.reset resetDomainSysInfo {3}
	...
	add_connection s10_user_rst_clkgate_1.ninit_done/jtag_uart.reset
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/jtag_uart.reset clockDomainSysInfo {4}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/jtag_uart.reset clockResetSysInfo {}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/jtag_uart.reset resetDomainSysInfo {4}
	add_connection s10_user_rst_clkgate_1.ninit_done/niosv.reset
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/niosv.reset clockDomainSysInfo {4}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/niosv.reset clockResetSysInfo {}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/niosv.reset resetDomainSysInfo {4}
	add_connection s10_user_rst_clkgate_1.ninit_done/onchip_mem.reset1
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/onchip_mem.reset1 clockDomainSysInfo {4}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/onchip_mem.reset1 clockResetSysInfo {}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/onchip_mem.reset1 resetDomainSysInfo {4}
	add_connection s10_user_rst_clkgate_1.ninit_done/sysid.reset
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/sysid.reset clockDomainSysInfo {4}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/sysid.reset clockResetSysInfo {}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/sysid.reset resetDomainSysInfo {4}
	add_connection s10_user_rst_clkgate_1.ninit_done/timer_0.reset
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/timer_0.reset clockDomainSysInfo {4}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/timer_0.reset clockResetSysInfo {}
	set_connection_parameter_value s10_user_rst_clkgate_1.ninit_done/timer_0.reset resetDomainSysInfo {4}
	add_connection timer_0.resetrequest/jtag_uart.reset
	set_connection_parameter_value timer_0.resetrequest/jtag_uart.reset clockDomainSysInfo {5}
	set_connection_parameter_value timer_0.resetrequest/jtag_uart.reset clockResetSysInfo {}
	set_connection_parameter_value timer_0.resetrequest/jtag_uart.reset resetDomainSysInfo {5}
	add_connection timer_0.resetrequest/niosv.reset
	set_connection_parameter_value timer_0.resetrequest/niosv.reset clockDomainSysInfo {5}
	set_connection_parameter_value timer_0.resetrequest/niosv.reset clockResetSysInfo {}
	set_connection_parameter_value timer_0.resetrequest/niosv.reset resetDomainSysInfo {5}
	add_connection timer_0.resetrequest/onchip_mem.reset1
	set_connection_parameter_value timer_0.resetrequest/onchip_mem.reset1 clockDomainSysInfo {5}
	set_connection_parameter_value timer_0.resetrequest/onchip_mem.reset1 clockResetSysInfo {}
	set_connection_parameter_value timer_0.resetrequest/onchip_mem.reset1 resetDomainSysInfo {5}
	add_connection timer_0.resetrequest/sysid.reset
	set_connection_parameter_value timer_0.resetrequest/sysid.reset clockDomainSysInfo {5}
	set_connection_parameter_value timer_0.resetrequest/sysid.reset clockResetSysInfo {}
	set_connection_parameter_value timer_0.resetrequest/sysid.reset resetDomainSysInfo {5}
	add_connection timer_0.resetrequest/timer_0.reset
	set_connection_parameter_value timer_0.resetrequest/timer_0.reset clockDomainSysInfo {5}
	set_connection_parameter_value timer_0.resetrequest/timer_0.reset clockResetSysInfo {}
	set_connection_parameter_value timer_0.resetrequest/timer_0.reset resetDomainSysInfo {5}
	...
	set_domain_assignment niosv.data_manager qsys_mm.burstAdapterImplementation GENERIC_CONVERTER
	set_domain_assignment niosv.data_manager qsys_mm.clockCrossingAdapter HANDSHAKE
	set_domain_assignment niosv.data_manager qsys_mm.enableAllPipelines FALSE
	set_domain_assignment niosv.data_manager qsys_mm.enableEccProtection FALSE
	set_domain_assignment niosv.data_manager qsys_mm.enableInstrumentation FALSE
	set_domain_assignment niosv.data_manager qsys_mm.enableOutOfOrderSupport FALSE
	set_domain_assignment niosv.data_manager qsys_mm.insertDefaultSlave FALSE
	set_domain_assignment niosv.data_manager qsys_mm.interconnectResetSource DEFAULT
	set_domain_assignment niosv.data_manager qsys_mm.interconnectType STANDARD
	set_domain_assignment niosv.data_manager qsys_mm.maxAdditionalLatency 1
	set_domain_assignment niosv.data_manager qsys_mm.optimizeRdFifoSize FALSE
	set_domain_assignment niosv.data_manager qsys_mm.piplineType PIPELINE_STAGE
	set_domain_assignment niosv.data_manager qsys_mm.responseFifoType REGISTER_BASED
	set_domain_assignment niosv.data_manager qsys_mm.syncResets TRUE
	set_domain_assignment niosv.data_manager qsys_mm.widthAdapterImplementation GENERIC_CONVERTER
...
<bonusData>
 ...
 <element __value="timer_0.s1">
  <datum __value="baseAddress" value="1114176" type="String" />
	...
	set_module_property FILE {qsys_ag.qsys}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {qsys_ag}
