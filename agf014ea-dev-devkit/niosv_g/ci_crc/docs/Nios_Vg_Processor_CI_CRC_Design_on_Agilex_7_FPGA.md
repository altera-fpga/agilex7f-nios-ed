...
### Agilex 7 FPGA - Custom Instruction CRC Design Example on Nios® V/g Processor Design Overview
...
#### Binaries
 - Prebuilt binaries are located [here](https://github.com/altera-fpga/agilex7f-nios-ed/tree/rel/25.1.1/agf014ea-dev-devkit/niosv_g/ci_crc/ready_to_test).
 - The sof and elf files required to run the design can be found in "ready_to_test" folder 
 - Program the sof and download the elf file on board

### Custom Instruction CRC Design Example on Nios® V/g Processor Design Architecture
