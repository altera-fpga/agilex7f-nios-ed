...
proc do_create_sys {} {
	...
	apply_component_preset intel_niosv_g_0
	save_component
	...
	add_connection s10_user_rst_clkgate_0.ninit_done/reset_bridge_1.in_reset
	set_connection_parameter_value s10_user_rst_clkgate_0.ninit_done/reset_bridge_1.in_reset clockDomainSysInfo {2}
	set_connection_parameter_value s10_user_rst_clkgate_0.ninit_done/reset_bridge_1.in_reset clockResetSysInfo {}
	set_connection_parameter_value s10_user_rst_clkgate_0.ninit_done/reset_bridge_1.in_reset resetDomainSysInfo {2}
