...
proc do_create_sys {} {
	...
	save_instantiation
	add_component crc_custom_pe_1 ip/sys/sys_crc_custom_pe_1.ip crc_custom_pe crc_custom_pe_1
	load_component crc_custom_pe_1
	set_component_parameter_value crc_width {32}
	set_component_parameter_value polynomial {79764919}
	set_component_parameter_value polynomial_inital {-1}
	set_component_parameter_value reflected_input {1}
	set_component_parameter_value reflected_output {1}
	set_component_parameter_value xor_output {-1}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation crc_custom_pe_1
	remove_instantiation_interfaces_and_ports
	...
	apply_component_preset onchip_memory2
	save_component
	add_component reset_bridge_1 ip/sys/sys_reset_bridge_1.ip altera_reset_bridge reset_bridge_1
	...
	set_component_parameter_value id {-1497904935}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation sysid_qsys_0
	remove_instantiation_interfaces_and_ports
	set_instantiation_assignment_value embeddedsw.CMacro.ID {-1497904935}
	...
	set_instantiation_assignment_value embeddedsw.dts.params.id {-1497904935}
	...
	add_connection clock_in.out_clk/reset_bridge_1.clk
	set_connection_parameter_value clock_in.out_clk/reset_bridge_1.clk clockDomainSysInfo {1}
	set_connection_parameter_value clock_in.out_clk/reset_bridge_1.clk clockRateSysInfo {50000000.0}
	set_connection_parameter_value clock_in.out_clk/reset_bridge_1.clk clockResetSysInfo {}
	set_connection_parameter_value clock_in.out_clk/reset_bridge_1.clk resetDomainSysInfo {1}
	...
	add_connection intel_niosv_g_0.ci_custom0_000/crc_custom_pe_1.niosv_custom_instruction_subordinate
	set_connection_parameter_value intel_niosv_g_0.ci_custom0_000/crc_custom_pe_1.niosv_custom_instruction_subordinate CIName {}
	set_connection_parameter_value intel_niosv_g_0.ci_custom0_000/crc_custom_pe_1.niosv_custom_instruction_subordinate CINameUpgrade {}
	set_connection_parameter_value intel_niosv_g_0.ci_custom0_000/crc_custom_pe_1.niosv_custom_instruction_subordinate baseAddress {0.0}
	set_connection_parameter_value intel_niosv_g_0.ci_custom0_000/crc_custom_pe_1.niosv_custom_instruction_subordinate customInstructionSubordinates {}
	...
	add_connection reset_bridge_1.out_reset/intel_niosv_g_0.reset
	set_connection_parameter_value reset_bridge_1.out_reset/intel_niosv_g_0.reset clockDomainSysInfo {2}
	set_connection_parameter_value reset_bridge_1.out_reset/intel_niosv_g_0.reset clockResetSysInfo {}
	set_connection_parameter_value reset_bridge_1.out_reset/intel_niosv_g_0.reset resetDomainSysInfo {2}
	add_connection reset_bridge_1.out_reset/jtag_uart_0.reset
	set_connection_parameter_value reset_bridge_1.out_reset/jtag_uart_0.reset clockDomainSysInfo {2}
	set_connection_parameter_value reset_bridge_1.out_reset/jtag_uart_0.reset clockResetSysInfo {}
	set_connection_parameter_value reset_bridge_1.out_reset/jtag_uart_0.reset resetDomainSysInfo {2}
	add_connection reset_bridge_1.out_reset/onchip_memory2_0.reset1
	set_connection_parameter_value reset_bridge_1.out_reset/onchip_memory2_0.reset1 clockDomainSysInfo {2}
	set_connection_parameter_value reset_bridge_1.out_reset/onchip_memory2_0.reset1 clockResetSysInfo {}
	set_connection_parameter_value reset_bridge_1.out_reset/onchip_memory2_0.reset1 resetDomainSysInfo {2}
	add_connection reset_bridge_1.out_reset/sysid_qsys_0.reset
	set_connection_parameter_value reset_bridge_1.out_reset/sysid_qsys_0.reset clockDomainSysInfo {2}
	set_connection_parameter_value reset_bridge_1.out_reset/sysid_qsys_0.reset clockResetSysInfo {}
	set_connection_parameter_value reset_bridge_1.out_reset/sysid_qsys_0.reset resetDomainSysInfo {2}
	add_connection reset_release.ninit_done/reset_bridge_1.in_reset
	set_connection_parameter_value reset_release.ninit_done/reset_bridge_1.in_reset clockDomainSysInfo {2}
	set_connection_parameter_value reset_release.ninit_done/reset_bridge_1.in_reset clockResetSysInfo {}
	set_connection_parameter_value reset_release.ninit_done/reset_bridge_1.in_reset resetDomainSysInfo {2}
...
<bonusData>
 ...
 <element __value="crc_custom_pe_1">
