...
proc do_create_qsys_top {} {
	...
	set_component_parameter_value Default_Timeout_Period {0}
	...
	set_component_parameter_value dataCacheSize {8192}
	...
	set_component_parameter_value enableLockstep {1}
	...
	set_component_parameter_value instCacheSize {8192}
	...
	set_component_parameter_value resetSlave {intel_onchip_memory_1.s1}
	set_component_parameter_value useResetReq {1}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	...
	set_instantiation_assignment_value embeddedsw.CMacro.DCACHE_SIZE {8192}
	...
	set_instantiation_assignment_value embeddedsw.CMacro.ICACHE_SIZE {8192}
	...
	set_instantiation_assignment_value embeddedsw.configuration.resetSlave {intel_onchip_memory_1.s1}
	...
	set_instantiation_assignment_value embeddedsw.dts.params.dcache-size {8192}
	set_instantiation_assignment_value embeddedsw.dts.params.icache-line-size {32}
	set_instantiation_assignment_value embeddedsw.dts.params.icache-size {8192}
	...
	add_instantiation_interface cpu_resetreq conduit INPUT
	set_instantiation_interface_parameter_value cpu_resetreq associatedClock {}
	set_instantiation_interface_parameter_value cpu_resetreq associatedReset {}
	set_instantiation_interface_parameter_value cpu_resetreq prSafe {false}
	add_instantiation_interface_port cpu_resetreq cpu_resetreq_resetreq resetreq 1 STD_LOGIC Input
	add_instantiation_interface_port cpu_resetreq cpu_resetreq_ack ack 1 STD_LOGIC Output
	...
	add_instantiation_interface lockstep_configuration avalon INPUT
	set_instantiation_interface_parameter_value lockstep_configuration addressAlignment {DYNAMIC}
	set_instantiation_interface_parameter_value lockstep_configuration addressGroup {0}
	set_instantiation_interface_parameter_value lockstep_configuration addressSpan {65536}
	set_instantiation_interface_parameter_value lockstep_configuration addressUnits {WORDS}
	set_instantiation_interface_parameter_value lockstep_configuration alwaysBurstMaxBurst {false}
	set_instantiation_interface_parameter_value lockstep_configuration associatedClock {clk}
	set_instantiation_interface_parameter_value lockstep_configuration associatedReset {reset}
	set_instantiation_interface_parameter_value lockstep_configuration bitsPerSymbol {8}
	set_instantiation_interface_parameter_value lockstep_configuration bridgedAddressOffset {0}
	set_instantiation_interface_parameter_value lockstep_configuration bridgesToMaster {}
	set_instantiation_interface_parameter_value lockstep_configuration burstOnBurstBoundariesOnly {false}
	set_instantiation_interface_parameter_value lockstep_configuration burstcountUnits {WORDS}
	set_instantiation_interface_parameter_value lockstep_configuration constantBurstBehavior {false}
	set_instantiation_interface_parameter_value lockstep_configuration dfhFeatureGuid {0}
	set_instantiation_interface_parameter_value lockstep_configuration dfhFeatureId {35}
	set_instantiation_interface_parameter_value lockstep_configuration dfhFeatureMajorVersion {0}
	set_instantiation_interface_parameter_value lockstep_configuration dfhFeatureMinorVersion {0}
	set_instantiation_interface_parameter_value lockstep_configuration dfhFeatureType {3}
	set_instantiation_interface_parameter_value lockstep_configuration dfhGroupId {0}
	set_instantiation_interface_parameter_value lockstep_configuration dfhParameterData {}
	set_instantiation_interface_parameter_value lockstep_configuration dfhParameterDataLength {}
	set_instantiation_interface_parameter_value lockstep_configuration dfhParameterId {}
	set_instantiation_interface_parameter_value lockstep_configuration dfhParameterName {}
	set_instantiation_interface_parameter_value lockstep_configuration dfhParameterVersion {}
	set_instantiation_interface_parameter_value lockstep_configuration explicitAddressSpan {0}
	set_instantiation_interface_parameter_value lockstep_configuration holdTime {0}
	set_instantiation_interface_parameter_value lockstep_configuration interleaveBursts {false}
	set_instantiation_interface_parameter_value lockstep_configuration isBigEndian {false}
	set_instantiation_interface_parameter_value lockstep_configuration isFlash {false}
	set_instantiation_interface_parameter_value lockstep_configuration isMemoryDevice {false}
	set_instantiation_interface_parameter_value lockstep_configuration isNonVolatileStorage {false}
	set_instantiation_interface_parameter_value lockstep_configuration linewrapBursts {false}
	set_instantiation_interface_parameter_value lockstep_configuration maximumPendingReadTransactions {1}
	set_instantiation_interface_parameter_value lockstep_configuration maximumPendingWriteTransactions {0}
	set_instantiation_interface_parameter_value lockstep_configuration minimumReadLatency {1}
	set_instantiation_interface_parameter_value lockstep_configuration minimumResponseLatency {1}
	set_instantiation_interface_parameter_value lockstep_configuration minimumUninterruptedRunLength {1}
	set_instantiation_interface_parameter_value lockstep_configuration prSafe {false}
	set_instantiation_interface_parameter_value lockstep_configuration printableDevice {false}
	set_instantiation_interface_parameter_value lockstep_configuration readLatency {0}
	set_instantiation_interface_parameter_value lockstep_configuration readWaitStates {1}
	set_instantiation_interface_parameter_value lockstep_configuration readWaitTime {1}
	set_instantiation_interface_parameter_value lockstep_configuration registerIncomingSignals {false}
	set_instantiation_interface_parameter_value lockstep_configuration registerOutgoingSignals {false}
	set_instantiation_interface_parameter_value lockstep_configuration setupTime {0}
	set_instantiation_interface_parameter_value lockstep_configuration timingUnits {Cycles}
	set_instantiation_interface_parameter_value lockstep_configuration transparentBridge {false}
	set_instantiation_interface_parameter_value lockstep_configuration waitrequestAllowance {0}
	set_instantiation_interface_parameter_value lockstep_configuration waitrequestTimeout {1024}
	set_instantiation_interface_parameter_value lockstep_configuration wellBehavedWaitrequest {false}
	set_instantiation_interface_parameter_value lockstep_configuration writeLatency {0}
	set_instantiation_interface_parameter_value lockstep_configuration writeWaitStates {0}
	set_instantiation_interface_parameter_value lockstep_configuration writeWaitTime {0}
	set_instantiation_interface_assignment_value lockstep_configuration embeddedsw.configuration.hideDevice {1}
	set_instantiation_interface_assignment_value lockstep_configuration embeddedsw.configuration.isFlash {0}
	set_instantiation_interface_assignment_value lockstep_configuration embeddedsw.configuration.isMemoryDevice {0}
	set_instantiation_interface_assignment_value lockstep_configuration embeddedsw.configuration.isNonVolatileStorage {0}
	set_instantiation_interface_assignment_value lockstep_configuration embeddedsw.configuration.isPrintableDevice {0}
	set_instantiation_interface_sysinfo_parameter_value lockstep_configuration address_map {<address-map><slave name='lockstep_configuration' start='0x0' end='0x10000' datawidth='32' /></address-map>}
	set_instantiation_interface_sysinfo_parameter_value lockstep_configuration address_width {16}
	set_instantiation_interface_sysinfo_parameter_value lockstep_configuration max_slave_data_width {32}
	add_instantiation_interface_port lockstep_configuration lockstep_configuration_address address 14 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port lockstep_configuration lockstep_configuration_byteenable byteenable 4 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port lockstep_configuration lockstep_configuration_read read 1 STD_LOGIC Input
	add_instantiation_interface_port lockstep_configuration lockstep_configuration_write write 1 STD_LOGIC Input
	add_instantiation_interface_port lockstep_configuration lockstep_configuration_writedata writedata 32 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port lockstep_configuration lockstep_configuration_readdata readdata 32 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port lockstep_configuration lockstep_configuration_readdatavalid readdatavalid 1 STD_LOGIC Output
	add_instantiation_interface_port lockstep_configuration lockstep_configuration_waitrequest waitrequest 1 STD_LOGIC Output
	add_instantiation_interface lockstep_intf conduit INPUT
	set_instantiation_interface_parameter_value lockstep_intf associatedClock {}
	set_instantiation_interface_parameter_value lockstep_intf associatedReset {}
	set_instantiation_interface_parameter_value lockstep_intf prSafe {false}
	add_instantiation_interface_port lockstep_intf lockstep_intf_silentmode silentmode 4 STD_LOGIC_VECTOR Input
	add_instantiation_interface_port lockstep_intf lockstep_intf_intreq intreq 1 STD_LOGIC Output
	add_instantiation_interface_port lockstep_intf lockstep_intf_oknok oknok 2 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port lockstep_intf lockstep_intf_error error 2 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port lockstep_intf lockstep_intf_warning warning 2 STD_LOGIC_VECTOR Output
	add_instantiation_interface_port lockstep_intf lockstep_intf_info info 2 STD_LOGIC_VECTOR Output
	...
	set_instantiation_interface_sysinfo_parameter_value axi_s1 address_map {<address-map><slave name='axi_s1' start='0x0' end='0x40000' datawidth='32' /></address-map>}
	set_instantiation_interface_sysinfo_parameter_value axi_s1 address_width {18}
	...
	add_instantiation_interface_port axi_s1 s1_araddr araddr 18 STD_LOGIC_VECTOR Input
	...
	add_instantiation_interface_port axi_s1 s1_awaddr awaddr 18 STD_LOGIC_VECTOR Input
	...
	save_instantiation
	add_component jtag_uart_1 ip/qsys_top/qsys_top_jtag_uart_1.ip altera_avalon_jtag_uart jtag_uart_1
	load_component jtag_uart_1
	set_component_parameter_value allowMultipleConnections {0}
	set_component_parameter_value hubInstanceID {0}
	set_component_parameter_value printingMethod {0}
	set_component_parameter_value readBufferDepth {64}
	...
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation jtag_uart_1
	remove_instantiation_interfaces_and_ports
	set_instantiation_assignment_value embeddedsw.CMacro.READ_DEPTH {64}
	set_instantiation_assignment_value embeddedsw.CMacro.READ_THRESHOLD {8}
	set_instantiation_assignment_value embeddedsw.CMacro.WRITE_DEPTH {64}
	...
	save_instantiation
	add_component rst_ack_pio ip/qsys_top/qsys_top_pio_1.ip altera_avalon_pio pio_1
	load_component rst_ack_pio
	...
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation rst_ack_pio
	remove_instantiation_interfaces_and_ports
	...
	add_instantiation_interface_port external_connection out_port export 2 STD_LOGIC_VECTOR Output
	save_instantiation
	add_component rst_req_pio ip/qsys_top/qsys_top_pio_2.ip altera_avalon_pio pio_2
	load_component rst_req_pio
	set_component_parameter_value bitClearingEdgeCapReg {0}
	set_component_parameter_value bitModifyingOutReg {0}
	...
	set_component_parameter_value simDoTestBenchWiring {0}
	set_component_parameter_value simDrivenValue {0.0}
	set_component_parameter_value width {1}
	set_component_project_property HIDE_FROM_IP_CATALOG {false}
	save_component
	load_instantiation rst_req_pio
	remove_instantiation_interfaces_and_ports
	set_instantiation_assignment_value embeddedsw.CMacro.BIT_CLEARING_EDGE_REGISTER {0}
	set_instantiation_assignment_value embeddedsw.CMacro.BIT_MODIFYING_OUTPUT_REGISTER {0}
	set_instantiation_assignment_value embeddedsw.CMacro.CAPTURE {0}
	set_instantiation_assignment_value embeddedsw.CMacro.DATA_WIDTH {1}
	set_instantiation_assignment_value embeddedsw.CMacro.DO_TEST_BENCH_WIRING {0}
	set_instantiation_assignment_value embeddedsw.CMacro.DRIVEN_SIM_VALUE {0}
	set_instantiation_assignment_value embeddedsw.CMacro.EDGE_TYPE {NONE}
	set_instantiation_assignment_value embeddedsw.CMacro.FREQ {100000000}
	...
	set_instantiation_assignment_value embeddedsw.dts.group {gpio}
	set_instantiation_assignment_value embeddedsw.dts.name {pio}
	set_instantiation_assignment_value embeddedsw.dts.params.altr,gpio-bank-width {1}
	set_instantiation_assignment_value embeddedsw.dts.params.resetvalue {0}
	set_instantiation_assignment_value embeddedsw.dts.vendor {altr}
	add_instantiation_interface clk clock INPUT
	set_instantiation_interface_parameter_value clk clockRate {0}
	...
	add_instantiation_interface_port s1 chipselect chipselect 1 STD_LOGIC Input
	add_instantiation_interface_port s1 readdata readdata 32 STD_LOGIC_VECTOR Output
	add_instantiation_interface external_connection reset OUTPUT
	set_instantiation_interface_parameter_value external_connection associatedClock {clk}
	set_instantiation_interface_parameter_value external_connection associatedDirectReset {}
	set_instantiation_interface_parameter_value external_connection associatedResetSinks {}
	set_instantiation_interface_parameter_value external_connection synchronousEdges {DEASSERT}
	add_instantiation_interface_port external_connection out_port reset 1 STD_LOGIC Output
	save_instantiation
	...
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_niosv_g_0.dm_agent addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_g_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_0.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /></address-map>}
	...
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_niosv_g_0.dm_agent baseAddress {0x00040000}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_niosv_g_0.dm_agent cpuInfoIdSysInfo {}
	...
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_niosv_g_0.timer_sw_agent addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_g_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_0.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /></address-map>}
	...
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_niosv_g_0.timer_sw_agent baseAddress {0x00050000}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_niosv_g_0.timer_sw_agent cpuInfoIdSysInfo {}
	...
	add_connection intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_g_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_0.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /></address-map>}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 baseAddress {0x0000}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 defaultConnection {0}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 domainAlias {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_g_0.data_manager/intel_onchip_memory_1.s1 slaveDataWidthSysInfo {-1}
	add_connection intel_niosv_g_0.data_manager/jtag_uart_0.avalon_jtag_slave
	set_connection_parameter_value intel_niosv_g_0.data_manager/jtag_uart_0.avalon_jtag_slave addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_g_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_0.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /></address-map>}
	...
	set_connection_parameter_value intel_niosv_g_0.data_manager/jtag_uart_0.avalon_jtag_slave baseAddress {0x00050040}
	set_connection_parameter_value intel_niosv_g_0.data_manager/jtag_uart_0.avalon_jtag_slave cpuInfoIdSysInfo {}
	...
	add_connection intel_niosv_g_0.data_manager/rst_ack_pio.s1
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_g_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_0.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /></address-map>}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 baseAddress {0x00050050}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 defaultConnection {0}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 domainAlias {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_ack_pio.s1 slaveDataWidthSysInfo {-1}
	add_connection intel_niosv_g_0.data_manager/rst_req_pio.s1
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_g_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_0.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /></address-map>}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 baseAddress {0x00050060}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 defaultConnection {0}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 domainAlias {}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_g_0.data_manager/rst_req_pio.s1 slaveDataWidthSysInfo {-1}
	add_connection intel_niosv_g_0.data_manager/sysid_qsys_0.control_slave
	set_connection_parameter_value intel_niosv_g_0.data_manager/sysid_qsys_0.control_slave addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_g_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_0.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /></address-map>}
	...
	set_connection_parameter_value intel_niosv_g_0.data_manager/sysid_qsys_0.control_slave baseAddress {0x00050048}
	set_connection_parameter_value intel_niosv_g_0.data_manager/sysid_qsys_0.control_slave cpuInfoIdSysInfo {}
	...
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_niosv_g_0.dm_agent addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /></address-map>}
	...
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_niosv_g_0.dm_agent baseAddress {0x00040000}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_niosv_g_0.dm_agent cpuInfoIdSysInfo {}
	...
	add_connection intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 addressMapSysInfo {<address-map><slave name='intel_onchip_memory_1.s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_g_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /></address-map>}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 baseAddress {0x0000}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 defaultConnection {0}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 domainAlias {}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_g_0.instruction_manager/intel_onchip_memory_1.s1 slaveDataWidthSysInfo {-1}
	...
	add_connection intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration addressMapSysInfo {<address-map><slave name='intel_onchip_memory_0.axi_s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_m_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_m_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_1.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /><slave name='intel_niosv_g_0.lockstep_configuration' start='0x60000' end='0x70000' datawidth='32' /></address-map>}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration baseAddress {0x00060000}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration cpuInfoIdSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration defaultConnection {0}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration domainAlias {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_g_0.lockstep_configuration slaveDataWidthSysInfo {-1}
	...
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_niosv_m_0.timer_sw_agent addressMapSysInfo {<address-map><slave name='intel_onchip_memory_0.axi_s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_m_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_m_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_1.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /><slave name='intel_niosv_g_0.lockstep_configuration' start='0x60000' end='0x70000' datawidth='32' /></address-map>}
	...
	set_connection_parameter_value intel_niosv_m_0.data_manager/intel_onchip_memory_0.axi_s1 cpuInfoIdSysInfo {}
	...
	add_connection intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave addressMapSysInfo {<address-map><slave name='intel_onchip_memory_0.axi_s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_m_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_m_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_1.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /><slave name='intel_niosv_g_0.lockstep_configuration' start='0x60000' end='0x70000' datawidth='32' /></address-map>}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave baseAddress {0x00050040}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave cpuInfoIdSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave defaultConnection {0}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave domainAlias {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_1.avalon_jtag_slave slaveDataWidthSysInfo {-1}
	add_connection intel_niosv_m_0.data_manager/rst_ack_pio.s1
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 addressMapSysInfo {<address-map><slave name='intel_onchip_memory_0.axi_s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_m_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_m_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_1.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /><slave name='intel_niosv_g_0.lockstep_configuration' start='0x60000' end='0x70000' datawidth='32' /></address-map>}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 baseAddress {0x00050050}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 defaultConnection {0}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 domainAlias {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_ack_pio.s1 slaveDataWidthSysInfo {-1}
	add_connection intel_niosv_m_0.data_manager/rst_req_pio.s1
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 addressMapSysInfo {<address-map><slave name='intel_onchip_memory_0.axi_s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_m_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /><slave name='intel_niosv_m_0.timer_sw_agent' start='0x50000' end='0x50040' datawidth='32' /><slave name='jtag_uart_1.avalon_jtag_slave' start='0x50040' end='0x50048' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x50048' end='0x50050' datawidth='32' /><slave name='rst_ack_pio.s1' start='0x50050' end='0x50060' datawidth='32' /><slave name='rst_req_pio.s1' start='0x50060' end='0x50070' datawidth='32' /><slave name='intel_niosv_g_0.lockstep_configuration' start='0x60000' end='0x70000' datawidth='32' /></address-map>}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 baseAddress {0x00050060}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 cpuInfoIdSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 defaultConnection {0}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 domainAlias {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/rst_req_pio.s1 slaveDataWidthSysInfo {-1}
	...
	set_connection_parameter_value intel_niosv_m_0.data_manager/sysid_qsys_0.control_slave baseAddress {0x00050048}
	...
	set_connection_parameter_value intel_niosv_m_0.instruction_manager/intel_niosv_m_0.dm_agent addressMapSysInfo {<address-map><slave name='intel_onchip_memory_0.axi_s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_m_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /></address-map>}
	...
	set_connection_parameter_value intel_niosv_m_0.instruction_manager/intel_onchip_memory_0.axi_s1 addressMapSysInfo {<address-map><slave name='intel_onchip_memory_0.axi_s1' start='0x0' end='0x40000' datawidth='32' /><slave name='intel_niosv_m_0.dm_agent' start='0x40000' end='0x50000' datawidth='32' /></address-map>}
	...
	set_connection_parameter_value intel_niosv_m_0.instruction_manager/intel_onchip_memory_0.axi_s1 cpuInfoIdSysInfo {}
	...
	add_connection intel_niosv_m_0.platform_irq_rx/jtag_uart_1.irq
	set_connection_parameter_value intel_niosv_m_0.platform_irq_rx/jtag_uart_1.irq interruptsUsedSysInfo {1}
	set_connection_parameter_value intel_niosv_m_0.platform_irq_rx/jtag_uart_1.irq irqNumber {0}
	...
	add_connection iopll_0.locked/jtag_uart_1.reset
	set_connection_parameter_value iopll_0.locked/jtag_uart_1.reset clockDomainSysInfo {2}
	set_connection_parameter_value iopll_0.locked/jtag_uart_1.reset clockResetSysInfo {}
	set_connection_parameter_value iopll_0.locked/jtag_uart_1.reset resetDomainSysInfo {2}
	add_connection iopll_0.locked/rst_ack_pio.reset
	set_connection_parameter_value iopll_0.locked/rst_ack_pio.reset clockDomainSysInfo {2}
	set_connection_parameter_value iopll_0.locked/rst_ack_pio.reset clockResetSysInfo {}
	set_connection_parameter_value iopll_0.locked/rst_ack_pio.reset resetDomainSysInfo {2}
	add_connection iopll_0.locked/rst_req_pio.reset
	set_connection_parameter_value iopll_0.locked/rst_req_pio.reset clockDomainSysInfo {2}
	set_connection_parameter_value iopll_0.locked/rst_req_pio.reset clockResetSysInfo {}
	set_connection_parameter_value iopll_0.locked/rst_req_pio.reset resetDomainSysInfo {2}
	...
	add_connection iopll_0.outclk0/jtag_uart_1.clk
	set_connection_parameter_value iopll_0.outclk0/jtag_uart_1.clk clockDomainSysInfo {3}
	set_connection_parameter_value iopll_0.outclk0/jtag_uart_1.clk clockRateSysInfo {100000000.0}
	set_connection_parameter_value iopll_0.outclk0/jtag_uart_1.clk clockResetSysInfo {}
	set_connection_parameter_value iopll_0.outclk0/jtag_uart_1.clk resetDomainSysInfo {3}
	add_connection iopll_0.outclk0/rst_ack_pio.clk
	set_connection_parameter_value iopll_0.outclk0/rst_ack_pio.clk clockDomainSysInfo {3}
	set_connection_parameter_value iopll_0.outclk0/rst_ack_pio.clk clockRateSysInfo {100000000.0}
	set_connection_parameter_value iopll_0.outclk0/rst_ack_pio.clk clockResetSysInfo {}
	set_connection_parameter_value iopll_0.outclk0/rst_ack_pio.clk resetDomainSysInfo {3}
	add_connection iopll_0.outclk0/rst_req_pio.clk
	set_connection_parameter_value iopll_0.outclk0/rst_req_pio.clk clockDomainSysInfo {3}
	set_connection_parameter_value iopll_0.outclk0/rst_req_pio.clk clockRateSysInfo {100000000.0}
	set_connection_parameter_value iopll_0.outclk0/rst_req_pio.clk clockResetSysInfo {}
	set_connection_parameter_value iopll_0.outclk0/rst_req_pio.clk resetDomainSysInfo {3}
	...
	add_connection rst_req_pio.external_connection/intel_niosv_g_0.reset
	set_connection_parameter_value rst_req_pio.external_connection/intel_niosv_g_0.reset clockDomainSysInfo {5}
	set_connection_parameter_value rst_req_pio.external_connection/intel_niosv_g_0.reset clockResetSysInfo {}
	set_connection_parameter_value rst_req_pio.external_connection/intel_niosv_g_0.reset resetDomainSysInfo {5}
...
<bonusData>
 ...
 <element __value="intel_niosv_g_0.lockstep_configuration">
  <datum __value="baseAddress" value="393216" type="String" />
 </element>
 ...
 <element __value="intel_onchip_memory_1.s1">
  <datum __value="baseAddress" value="0" type="String" />
 </element>
 ...
 <element __value="jtag_uart_1">
  <datum __value="_sortIndex" value="11" type="int" />
 </element>
 <element __value="jtag_uart_1.avalon_jtag_slave">
  <datum __value="baseAddress" value="327744" type="String" />
 </element>
 ...
 <element __value="rst_ack_pio">
  <datum __value="_sortIndex" value="8" type="int" />
 </element>
 <element __value="rst_ack_pio.s1">
  <datum __value="baseAddress" value="327760" type="String" />
 </element>
 <element __value="rst_req_pio">
  <datum __value="_sortIndex" value="9" type="int" />
 </element>
 <element __value="rst_req_pio.s1">
 ...
 <element __value="sysid_qsys_0.control_slave">
  <datum __value="baseAddress" value="327752" type="String" />
 </element>
</bonusData>
}
