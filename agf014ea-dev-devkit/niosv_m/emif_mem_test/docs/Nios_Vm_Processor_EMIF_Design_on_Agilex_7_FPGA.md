...
#### Binaries
 - Prebuilt binaries are located [here](https://github.com/altera-fpga/agilex7f-nios-ed/tree/rel/25.1.1/agf014ea-dev-devkit/niosv_m/emif_mem_tes/ready_to_test).
 - The sof and elf files required to run the design can be found in "ready_to_test" folder 
 - Program the sof and download the elf file on board


### Nios® V/m Processor – EMIF Data mover Design Architecture
...
![image](https://github.com/altera-fpga/agilex7f-nios-ed/blob/rel/25.1.1/agf014ea-dev-devkit/niosv_m/emif_mem_test/img/emif.png)
...
#### Nios V Address Map
 |Address Offset	|Size (Bytes)	|Peripheral	| Description|
  ...
  |0x8000_0000|4G|EMIF|To store data|
