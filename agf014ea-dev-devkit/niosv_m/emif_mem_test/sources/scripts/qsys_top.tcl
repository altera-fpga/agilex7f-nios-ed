...
proc do_create_qsys_top {} {
	...
	# Since preset is used, IP config here is not required. To be used for reference	
	proc comment_out_emif_config {} {
	...
	set_connection_parameter_value clock_in.out_clk/emif_cal_0.cal_debug_clk clockRateSysInfo {50000000.0}
	...
	add_connection intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 addressMapSysInfo {<address-map><slave name='intel_onchip_memory_0.axi_s1' start='0x0' end='0x100000' datawidth='32' /><slave name='intel_niosv_m_0.dm_agent' start='0x100000' end='0x110000' datawidth='32' /><slave name='intel_niosv_m_0.timer_sw_agent' start='0x110000' end='0x110040' datawidth='32' /><slave name='sysid_qsys_0.control_slave' start='0x110040' end='0x110048' datawidth='32' /><slave name='jtag_uart_0.avalon_jtag_slave' start='0x110048' end='0x110050' datawidth='32' /><slave name='emif_fm_0.ctrl_amm_0' start='0x80000000' end='0x100000000' datawidth='128' /></address-map>}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 addressWidthSysInfo {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 arbitrationPriority {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 baseAddress {0x80000000}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 defaultConnection {0}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 domainAlias {}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.burstAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.clockCrossingAdapter {HANDSHAKE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.enableAllPipelines {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.enableEccProtection {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.enableInstrumentation {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.enableOutOfOrderSupport {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.insertDefaultSlave {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.interconnectResetSource {DEFAULT}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.interconnectType {STANDARD}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.maxAdditionalLatency {1}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.optimizeRdFifoSize {FALSE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.piplineType {PIPELINE_STAGE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.responseFifoType {REGISTER_BASED}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.syncResets {TRUE}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 qsys_mm.widthAdapterImplementation {GENERIC_CONVERTER}
	set_connection_parameter_value intel_niosv_m_0.data_manager/emif_fm_0.ctrl_amm_0 slaveDataWidthSysInfo {-1}
	...
	set_connection_parameter_value intel_niosv_m_0.data_manager/jtag_uart_0.avalon_jtag_slave baseAddress {0x00110048}
	...
	set_connection_parameter_value intel_niosv_m_0.data_manager/sysid_qsys_0.control_slave baseAddress {0x00110040}
	...
	set_connection_parameter_value reset_bridge_0.out_reset/intel_niosv_m_0.reset clockDomainSysInfo {5}
	set_connection_parameter_value reset_bridge_0.out_reset/intel_niosv_m_0.reset clockResetSysInfo {}
	set_connection_parameter_value reset_bridge_0.out_reset/intel_niosv_m_0.reset resetDomainSysInfo {5}
	add_connection reset_bridge_0.out_reset/intel_onchip_memory_0.reset1
	set_connection_parameter_value reset_bridge_0.out_reset/intel_onchip_memory_0.reset1 clockDomainSysInfo {5}
	set_connection_parameter_value reset_bridge_0.out_reset/intel_onchip_memory_0.reset1 clockResetSysInfo {}
	set_connection_parameter_value reset_bridge_0.out_reset/intel_onchip_memory_0.reset1 resetDomainSysInfo {5}
	...
	set_connection_parameter_value s10_user_rst_clkgate_0.ninit_done/reset_bridge_0.in_reset clockDomainSysInfo {5}
	set_connection_parameter_value s10_user_rst_clkgate_0.ninit_done/reset_bridge_0.in_reset clockResetSysInfo {}
	set_connection_parameter_value s10_user_rst_clkgate_0.ninit_done/reset_bridge_0.in_reset resetDomainSysInfo {5}
...
<bonusData>
 ...
 <element __value="jtag_uart_0.avalon_jtag_slave">
  <datum __value="baseAddress" value="1114184" type="String" />
 </element>
