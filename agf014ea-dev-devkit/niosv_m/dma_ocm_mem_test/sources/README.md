# Nios® V/m Processor – DMA - OCM Memory Test
...
![image](https://github.com/altera-fpga/agilex7f-nios-ed/blob/rel/25.1.1/agf014ea-dev-devkit/niosv_m/dma_ocm_mem_test/img/block_diagram.png)
...
- **Design Package**: agilex7_niosv_m_dma_ocm_mem_test.zip
- **Category**: Memory
- **URL**: https://github.com/altera-fpga/agilex7f-nios-ed/blob/rel/25.1.1/agf014ea-dev-devkit/niosv_m/dma_ocm_mem_test/
- **download URL**: https://github.com/altera-fpga/agilex7f-nios-ed/releases/download/25.1.1-v1.0/agilex7_niosv_m_dma_ocm_mem_test.zip
